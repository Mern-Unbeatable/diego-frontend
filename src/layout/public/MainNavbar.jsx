                    ...
                    <>
                      ...
                      <div className="invisible absolute top-full z-50 mt-2 w-64 rounded-lg bg-white py-2 opacity-0 shadow-lg transition-all duration-200 group-hover:visible group-hover:opacity-100">
                        {item.dropdown.map((sub, i) => (
                          <div key={i} className="group/sub relative">
                            {sub.dropdown ? (
                              <span className="flex cursor-default items-center justify-between px-4 py-2 text-base font-semibold text-gray-700 hover:bg-[#EAF5F1] hover:text-[#568F79]">
                                {sub.label}
                                <FaChevronDown
                                  size={12}
                                  className="ml-2 rotate-[-90deg] transition-transform group-hover/sub:rotate-0"
                          ...
                          <div className="mt-1 space-y-2 pl-4">
                            {item.dropdown.map((sub, i) => (
                              <div key={i}>
                                {sub.dropdown ? (
                                  <div className="flex items-center justify-between">
                                    <span className="block cursor-default rounded-sm py-1 pl-4 text-base font-semibold break-words duration-200 hover:bg-[#EAF5F1] hover:text-[#568F79]">
                                      {sub.label}
                                    </span>
                                  </div>
                                ) : (
