        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mb-8 leading-relaxed text-gray-700">
              Corso avanzato per la gestione dei rischi nelle industrie a
              rischio di incidente rilevante secondo il Decreto Legislativo
              105/2015. Il corso fornisce competenze specifiche per la
              prevenzione degli incidenti rilevanti e la gestione delle
              emergenze.
            </p>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">
                    Comprendere la normativa SEVESO III
                  </span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="mt-0.5 h-5 w-5 flex-shrink-0 text-green-500" />
                  <span className="text-gray-700">
                    Identificare i rischi di incidente rilevante
                  </span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="mt-0.5 h-5 w-5 flex-shrink-0 text-green-500" />
                  <span className="text-gray-700">
                    Sviluppare piani di emergenza efficaci
                  </span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="mt-0.5 h-5 w-5 flex-shrink-0 text-green-500" />
                  <span className="text-gray-700">
                    Gestire la comunicazione in caso di emergenza
                  </span>
                </div>
              </div>
            </div>
