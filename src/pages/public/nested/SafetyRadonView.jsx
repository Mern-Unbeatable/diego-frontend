...
const SafetyRadonView = () => {
  ...
  const riskItems = t('servicesPages.radon.riskItems', { returnObjects: true });
  ...
  return (
    <Container className=" ">
      <Banner
        description={t('servicesPages.radon.bannerDescription')}
        image={banner}
        title={t('servicesPages.radon.bannerTitle')}
      />
          ...
          <div>
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 leading-relaxed mb-6">
                {t('servicesPages.radon.description')}
              </p>
