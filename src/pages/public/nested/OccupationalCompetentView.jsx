...
const OccupationalCompetentView = () => {
  ...
  return (
    <Container className=" ">
      <Banner
        image={banner}
        title={t('servicesPages.medicalCompetent.bannerTitle')}
        description={t('servicesPages.medicalCompetent.bannerDescription')}
      />
          ...
          <div>
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 leading-relaxed mb-6">
                {t('servicesPages.medicalCompetent.description')}
