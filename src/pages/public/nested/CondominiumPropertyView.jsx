          ...
          <div className="lg:sticky lg:top-24">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 leading-relaxed mb-6 text-justify">
                Analisi di laboratorio In alcuni casi specifici, in base alla mansione svolta, è necessario effettuare analisi di laboratorio per completare la valutazione dell’idoneità al lavoro. Questi controlli, richiesti dal D. Lgs. 81/08, permettent di accertare che il lavoratore sia nelle condizioni fisiche ottimali per svolgere le proprie attività in sicurezza. Non si tratta solo di un obbligo normativo, ma di una misura concreta di prevenzione e tutela, pensata per garantire il benessere del personale e mantenere elevati standard di sicurezza all’interno dell’azienda.
              </p>
