          ...
          <div className="lg:sticky lg:top-24">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 leading-relaxed mb-6 text-justify">
                La nomina del medico competente è un obbligo previsto dal D. Lgs. 81/08, in particolare dagli artt. 18 e 41, e rappresenta un elemento fundamental per la tutela della salute dei lavoratori. Il medico competente collabora alla valutazione dei rischi, effettua la sorveglianza sanitaria e contribuisce alla prevenzione di malattie professionali e infortuni, assicurando la conformità dell’azienda alla normativa vigente.
              </p>
