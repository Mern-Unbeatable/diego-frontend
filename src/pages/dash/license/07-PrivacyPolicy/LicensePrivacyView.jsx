...
const LicensePrivacyView = () => {
  return (
    <section className="mx-auto max-w-7xl rounded-xl bg-white px-4 py-6 text-[#2f2f2f] sm:px-8 sm:py-10 bg-[#FCFCFB]">
      <header className="mb-10 text-center">
        <p className="text-lg font-medium text-[#232323]">Privacy &amp; policy</p>
        <h1 className="mt-6 text-xl font-semibold uppercase text-[#232323]">
          Informativa privacy
        </h1>
      ...
      <div className="space-y-9">
        <section>
          <h2 className="mb-1 text-2xl font-semibold leading-[1.2] text-[#2b2b2b]">
            Titolare del trattamento
          </h2>
          <p className="text-lg leading-[1.45] text-[#3b3b3b]">
            UNOSICUREZZA SRL Via di Dio Fratelli, 5
          </p>
        ...
        <section>
          ...
          <p className="text-lg leading-[1.45] text-[#3b3b3b]">
            Questa informativa riguarda gli utenti che partecipano ai corsi obbligatori di
            formazione in materia di salute e sicurezza sul lavoro, erogati tramite piattaforma
            e-learning, ai sensi del D.lgs. 81/2008 e degli Accordi Stato-Regioni.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="space-y-6 pt-2">
            <div>
              <h3 className="mb-1 text-xl font-semibold leading-[1.2] text-[#2b2b2b]">
            ...
            <div>
              ...
              <ul className="list-disc pl-7 text-lg leading-[1.42] text-[#3b3b3b]">
                ...
                <li>
                  Mansione ricoperta (necessaria per individuare il percorso formativo
                  obbligatorio)
                </li>
              </ul>
            </div>
        ...
        <section>
          <h2 className="mb-2 text-2xl font-semibold leading-[1.2] text-[#2b2b2b]">
          ...
          <div className="space-y-5 pt-2">
            <div>
              ...
              <ul className="list-disc pl-7 text-lg leading-[1.42] text-[#3b3b3b]">
                ...
                <li>
                  Verifica dell&apos;apprendimento e tracciamento delle attività formative
                </li>
                <li>Rilascio e conservazione degli attestati</li>
                <li>
                  Adempimento degli obblighi normativi previsti dal D.lgs. 81/2008 e dagli
            ...
            <div>
              ...
              <ul className="list-disc pl-7 text-lg leading-[1.42] text-[#3b3b3b]">
                ...
                <li>
                  Esecuzione del contratto o di misure precontrattuali (art. 6, par. 1, lett. b
                  GDPR)
                </li>
              </ul>
            </div>
        ...
        <section>
          ...
          <p className="text-lg leading-[1.45] text-[#3b3b3b]">
            ...
            previsti dalla normativa sulla sicurezza. La mancata comunicazione dei dati impedisce
            la partecipazione ai corsi e il rilascio degli attestati.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-lg leading-[1.45] text-[#3b3b3b]">
            I dati non vengono trasferiti al di fuori dell&apos;Unione Europea. Eventuali
            trasferimenti futuri avverranno solo nel rispetto degli artt. 44-49 GDPR.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-7 text-lg leading-[1.42] text-[#3b3b3b]">
            <li>
              I dati relativi alla formazione obbligatoria e agli attestati sono conservati per il
              tempo necessario a dimostrare l&apos;adempimento degli obblighi formativi,
              generalmente 10 anni, salvo termini diversi previsti da norme specifiche.
            </li>
            <li>
        ...
        <section>
          ...
          <ul className="list-disc pl-7 text-lg leading-[1.42] text-[#3b3b3b]">
            <li>
              Eventuali modifiche ai dati personali possono essere richieste tramite comunicazione al
              Titolare, che provvederà tramite personale autorizzato.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-lg leading-[1.45] text-[#3b3b3b]">
            L&apos;interessato può inoltre proporre reclamo al Garante per la Protezione dei Dati
            Personali.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-lg leading-[1.45] text-[#3b3b3b]">
            Il Titolare adotta misure tecniche e organizzative adeguate a garantire la protezione dei
            dati, tra cui:
          </p>
          <ul className="list-disc pl-7 text-lg leading-[1.42] text-[#3b3b3b]">
...
export default LicensePrivacyView;
