...
const LicensePrivacyView = () => {
  return (
    <section className="mx-auto min-w-0 max-w-5xl overflow-hidden rounded-xl bg-[#FCFCFB] px-3 py-5 text-[#2f2f2f] sm:px-6 sm:py-8 md:px-8 md:py-10">
        ...
        <section>
          ...
          <ul className={listClass}>
            <li>
              ...
              tramite comunicazione al Titolare, che provvederà tramite
