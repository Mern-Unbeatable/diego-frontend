        ...
        <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-5 xl:grid-cols-[1fr_340px]">
                <article className="rounded-xl border border-[#e8e8e8] bg-white p-5">
                    <h3 className="mb-4 text-[30px] font-semibold text-[#1f1f1f]">Descrizione ticket</h3>
                    <div className="space-y-4 text-sm text-[#3e3e3e]">
                        <p>Dear Sir/Madam,</p>
                        <p>
                            I am experiencing an issue when logging into my hosting account using the email address
                            example@gmail.com. Upon logging in, I receive the following message:
                        </p>
                ...
                <article className="rounded-xl border border-[#e8e8e8] bg-white p-5">
                    <h3 className="mb-4 text-[30px] font-semibold text-[#1f1f1f]">Dettagli ticket</h3>
                    <div className="space-y-2 text-sm text-[#3f3f3f]">
                        <p>
                            <span className="font-semibold">ID:</span> 1234
                        </p>
                        <p>
                            <span className="font-semibold">Oggetto:</span> Access Issue - "Functionality Is Restricted" Message On Login
                        </p>
                        <p>
                            <span className="font-semibold">Tipologia richiedente:</span> Livello 2
                        </p>
                        <p>
                            <span className="font-semibold">Priorita:</span> Critical
                        </p>
                        <p>
                            <span className="font-semibold">Creato il:</span> GG/MM/AAAA 20:44:58
                        </p>
                        <p>
            ...
            <article className="rounded-xl border border-[#e8e8e8] bg-white p-5">
                <h3 className="mb-5 border-b border-[#ececec] pb-4 text-[32px] font-semibold text-[#1f1f1f]">Conversazione</h3>
                ...
                <div className="space-y-5">
                    <div className="space-y-2">
                        ...
                        <div className="max-w-[630px] rounded-md bg-[#edf5f2] p-3 text-sm text-[#4e4e4e]">
                            Thanks for sharing. We have shared your full root access to the server. Hope your issue is resolved now.
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="max-w-[630px] rounded-md bg-[#edf5f2] p-3 text-sm text-[#4e4e4e]">
                            Please find the screenshot what i am facing when login Attachment 1754493425.jpg
                        </div>
                    </div>
                </div>
            </article>
