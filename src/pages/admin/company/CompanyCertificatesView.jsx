...
const CompanyCertificatesView = () => {
    return (
        <section className="space-y-6">
            <h2 className="text-2xl font-semibold text-[#1f1f1f]">Elenco degli attestati</h2>
                    ...
                    <article key={card.id} className="space-y-4">
                        <div className="rounded-xl bg-[#edf5f2] p-5">
                            <p className="text-sm text-[#202020]">
                                <span className="font-semibold">Nominativo utente:</span> {card.name}
                            </p>
                            <p className="mt-1 text-sm text-[#202020]">
                                <span className="font-semibold">ID corsista:</span> {card.learnerId}
                            </p>
                            <p className="mt-1 text-sm text-[#202020]">
                        ...
                        <div className="overflow-hidden rounded-xl bg-[#23473f]">
                            <img
                                ...
                                onError={(event) => {
                                    ...
                                    event.currentTarget.className = 'h-[200px] w-full object-contain bg-[#1f3f38] p-8';
                                }}
                            />
                        </div>
