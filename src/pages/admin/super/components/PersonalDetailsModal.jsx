...
import { ArrowLeft, Calendar, Mail, Pencil, Phone, Trash2, User } from 'lucide-react';
                            ...
                            <table className="w-full min-w-[1220px] border-collapse">
                                <thead>
                                    <tr className="border-b border-[#d8d8d8] bg-[#e9e9e9]">
                                        <th className="px-7 py-5 text-left text-lg font-semibold text-[#1e1e1e]">Nome del Corso</th>
                                        <th className="px-7 py-5 text-left text-lg font-semibold text-[#1e1e1e]">Data di Inizio</th>
                                        <th className="px-7 py-5 text-left text-lg font-semibold text-[#1e1e1e]">Data di Fine</th>
                                        <th className="px-7 py-5 text-left text-lg font-semibold text-[#1e1e1e]">Tempo Totale</th>
                                        <th className="px-7 py-5 text-left text-lg font-semibold text-[#1e1e1e]">Punteggi Totali</th>
                                        <th className="px-7 py-5 text-left text-lg font-semibold text-[#1e1e1e]">Trainer</th>
                                        <th className="px-7 py-5 text-left text-lg font-semibold text-[#1e1e1e]">Sondaggio di Fine Corso</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {profile.courses.map((course) => (
                                        <tr key={course.id} className="border-b border-[#d8d8d8]">
                                            <td className="max-w-[200px] truncate px-7 py-4 text-lg text-[#202020]">{course.name}</td>
                                            <td className="px-7 py-4 text-lg text-[#202020]">{course.startDate}</td>
                                            <td className="px-7 py-4 text-lg text-[#202020]">{course.endDate}</td>
                                            <td className="px-7 py-4 text-lg text-[#202020]">{course.totalTime}</td>
                                            <td className="px-7 py-4 text-lg text-[#202020]">{course.score}</td>
                                            <td className="px-7 py-4 text-lg text-[#202020]">{course.trainer}</td>
                                            <td className="max-w-[250px] truncate px-7 py-4 text-lg text-[#202020]">{course.feedback}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
