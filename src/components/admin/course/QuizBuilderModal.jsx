...
export default function QuizBuilderModal({
  ...
  return (
    <Modal
      ...
      zIndex={120}
      showCloseButton={false}
      panelClassName="flex h-[100dvh] w-full max-w-full flex-col overflow-hidden p-0 sm:h-auto sm:max-h-[92vh] sm:w-auto sm:max-w-3xl sm:rounded-2xl"
    >
      <div className="sticky top-0 z-10 flex shrink-0 items-center justify-between border-b border-gray-200 bg-white px-4 py-3 sm:px-6 sm:py-4">
      ...
      {isLoadingQuiz ? (
        ...
        <div className="flex-1 overflow-y-auto py-5 sm:px-6 sm:py-6">
              ...
              <div>
                ...
                <div className="space-y-3 rounded-lg bg-gray-50 p-4">
                  <div className="flex flex-wrap justify-between gap-2">
                    <span className="text-sm text-gray-600">Titolo</span>
                    <span className="max-w-full break-words text-right text-sm font-medium">
                      {quizData.title}
                    </span>
                  </div>
                  <div className="flex flex-wrap justify-between gap-2">
              ...
              <div>
                ...
                <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                  <button
                    ...
                    onClick={() => handleSave()}
                    disabled={saving}
                    className="w-full rounded-lg bg-emerald-500 px-4 py-2 text-sm font-medium text-white hover:bg-emerald-600 disabled:opacity-60 sm:w-auto"
                  >
                    {saving ? 'Salvataggio...' : 'Salva quiz'}
                  </button>
                  <button
                    ...
                    onClick={() => handleSave(true)}
                    disabled={saving}
                    className="w-full rounded-lg bg-blue-500 px-4 py-2 text-sm font-medium text-white hover:bg-blue-600 disabled:opacity-60 sm:w-auto"
                  >
                    Pubblica ora
                  </button>
                </div>
          ...
          <div className="border-t pt-8">
            <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <button
                type="button"
                onClick={addQuestion}
                className="flex w-full items-center justify-center space-x-2 rounded-lg bg-emerald-500 px-4 py-2 text-sm font-medium text-white hover:bg-emerald-600 sm:w-auto"
              >
                <Plus className="h-4 w-4" />
                <span>Aggiungi domanda</span>
              </button>
                            ...
                            {question.options.map((option, optIndex) => (
                              ...
                              >
                                <input
                                  ...
                                  className="shrink-0 text-emerald-500 focus:ring-emerald-500"
                                />
                                <span className="w-4 shrink-0 text-sm font-medium text-gray-600">
                                  {optIndex + 1}.
                                </span>
                                <input
                                  type="text"
                                  ...
                                  placeholder={`Opzione ${optIndex + 1}`}
                                  disabled={isTrueFalseQuestion(question.questionType)}
                                  className="min-w-0 flex-1 rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 focus:outline-none disabled:bg-gray-100"
                                />
                                {!isTrueFalseQuestion(question.questionType) ? (
                                  <button
                                    type="button"
      ...
      <div className="sticky bottom-0 z-10 flex shrink-0 flex-col-reverse gap-3 border-t border-gray-200 bg-white px-4 py-4 sm:flex-row sm:justify-end sm:px-6">
        <button
          type="button"
          onClick={onBack}
          className="w-full rounded-lg border border-gray-300 bg-white px-6 py-2 text-sm font-medium text-gray-600 hover:bg-gray-50 sm:w-auto"
        >
          Annulla
        </button>
        <button
          ...
          onClick={() => handleSave()}
          disabled={saving}
          className="w-full rounded-lg bg-emerald-500 px-8 py-2 text-sm font-semibold text-white hover:bg-emerald-600 disabled:opacity-60 sm:w-auto"
        >
          {saving ? 'Salvataggio...' : 'Salva quiz'}
        </button>
      </div>
